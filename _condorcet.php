...
class Condorcet {
    /* A Schulze method implementation*/
	  ...
	  // 2017.01.25 hányan tették első helyre
	  ...
	  */	
      ...
      public function report() {
          ...
          $result .= '<p><i>"Elfogadható"</> adat jelentése: a jelöltet hányan sorolták a lehetséges poziciók felső 2/3 -ba.<br />
      ...
      private function loadDiffMatrix() {
		  ...
		  // FT 2017.01.25 érdekes lehet az is hányan tették az első helyre
          $this->inFirst = array();
		  if ($this->filter == '')
			  $filterWhere = '';
		  else
      ...
      private function showlist($shortlist) {
          ...
          foreach($shortlist as $i) {
              ...
              $result .= '<tr><td class="left">'.$this->candidates[$i]."</td>".
                             ...
                             '<td class="right">'.$this->accepted[$i]."</td>".
                             '<td class="right">'.$values[$i]."</td>".
                             '<td class="graph"><div style="display:inline-block; background-color:blue; width:'.$w2.'px;">&nbsp;</div>&nbsp;</td>'.
                         "</tr>\n";
		  ...
		  if ($res->cc == 0) {
			  ...
			  $result = '<div class="noVoksInfo">Ebben a szavazásban nincs egyetlen egy leadott szavazat sem.</div>';
		  }
