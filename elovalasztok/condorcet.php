...
class Condorcet {
    ...
    private $condorcetGyoztes = false;  // van condorcet gyöztes?
    ...
    public $vote_count = 0;
	  ...
	  */ 
      private function showResult($shortlist) {
		  ...
		  $this->condorcetGyoztes = true;
		  foreach  ($this->candidates as $j => $name) {
			if ($this->dMatrix[$i][$j] < $this->dMatrix[$j][$i]) $this->condorcetGyoztes = false;
		  }
